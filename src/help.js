...
╠══✪〘 NOVIDADES 〙✪══
║
║1 *${prefix}qrcode [n esta funcionando]*
║2 *${prefix}chentai [n esta funcionando]*
║3 *${prefix}gcpf [n esta funcionando]*
║4 *${prefix}gay [@]*
║5 *${prefix}gbin [n esta funcionando]*
║5 *${prefix}pack [n esta funcionando]*
║6 *${prefix}destrava [n esta funcionando]*
║7 *${prefix}gpessoa [n esta funcionando]*
║8 *${prefix}wame*
║9 *${prefix}spamcall*
...
║14 *${prefix}memeindo*
║15 *${prefix}tts*
║16 *${prefix}lolih [funcionando]*
║17 *${prefix}nsfwloli [n esta funcionando]*
║18 *${prefix}url2img*
...
╠══✪〘 IMAGENS 〙✪══
║
║54 *${prefix}loli* [n esta funcionando]
║55 *${prefix}loli1*
║56 *${prefix}hentai*
║57 *${prefix}dono*
║58 *${prefix}porno*
...
╠══✪〘 𝗗𝗢𝗡𝗢 〙✪══
║
║ *NOME:𖥨ํ∘̥⃟⸽⃟𝑃𝐸𝐷𝑅𝑂 𝑶𝑭 𝑯𝒀𝑷𝑬࿘*
║ *WPP: wa.me/+5512996299061*
║
║  *"Peita ou respeita!*
